    ...
    <div class="row-fluid mt10">
        <div class="span3">
			<div class="homebox">
				...
				<div class="non-user-upld"><a href="<?php echo Yii::app()->createUrl('user/login',array('rurl'=>$_SERVER['REQUEST_URI'])); ?>"><div class="qq-upload-button" style="width:60% !important;margin:10px auto 0 !important;">Upload Your ganesha</div></a></div>
		<?php	}else{
        ...
        array(
			...
			<div class="homebox" style="margin-top:30px;">
