...
?>
	...
	$singleurl = Yii::app()->createUrl('temple/templeview',array('temple_name'=>$temple->slug));
    ?>
    <div class="each-temple">
		...
		<div class="mb10"><a href="<?php echo Yii::app()->createUrl('temple/templeview',array('temple_name'=>$temple->slug))?>">Leave reply </a></div>
    </div>
	<?php if($i%2 == 0){ ?>
	 <div class="clear"></div>
	 <?php } ?>
