...
import com.devaganesha.devaganeshapics.util.ImageCache;
...
public class ImageDetailActivity extends FragmentActivity implements OnClickListener {
    private static final String IMAGE_CACHE_DIR = "devaganesha_images";
        ...
        switch (item.getItemId()) {
            ...
            case R.id.set_as_wallpaper:
                ...
                try {
                	...
                	Toast.makeText(
                			this, R.string.set_as_wallpaper_complete_toast, Toast.LENGTH_SHORT).show();
                } catch (IOException e) {
                	Toast.makeText(
                			this, R.string.set_as_wallpaper_failed_toast, Toast.LENGTH_SHORT).show();
                }
